...
# Pipe operator version of the square root of x:
x %>% sqrt
...
```{r}
df %>% 
  filter(date >= '2020-10-1', date <= '2020-11-30') %>% 
  group_by(weekend) %>% 
...
```{r}
df %>% 
  filter(date >= '2020-09-01', date <= '2020-12-30',) %>% 
  group_by(month2) %>% 
  summarise(death = median(death))
```
